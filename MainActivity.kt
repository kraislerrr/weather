    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        webViewya.webViewClient = object : WebViewClient() {
            override fun onPageFinished(view: WebView?, url: String?) {
                ...
                val scriptp = "document.getElementsByClassName('fact__props')[0].scrollIntoView();"
            ...
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                when (position) {
                    1 -> {
                        ...
                        webViewya.loadUrl("https://dzen.ru/pogoda/sochi?lat=43.585475&lon=39.723095")
                    }
                    2 -> {
                        ...
                        webViewya.loadUrl("https://dzen.ru/pogoda/?lat=45.04331589&lon=41.96910858")
                    }
                    3 -> {
                        ...
                        webViewya.loadUrl("https://dzen.ru/pogoda/2?via=moc")
                    }
                    else -> {
                        ...
                        webViewya.loadUrl("https://dzen.ru/pogoda/1107?via=moc")
                    }
                }
